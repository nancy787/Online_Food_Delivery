                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="o_hr" class="form-control custom-select" value="<?php echo $row['o_hr'];  ?>" data-placeholder="Choose a Category" >
                                            ...
                                            <!--/span-->
                                             <div class="col-md-6">
                                                <div class="form-group">
													...
													{
                                                       echo' <option value="'.$row['rs_id'].'">'.$row['c_hr'].'</option>';
													}  
											 ...
											 <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="o_days" class="form-control custom-select"  value="<?php echo $row['o_days'];  ?>" data-placeholder="Choose a Category" tabindex="1">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="address" type="text" style="height:100px;" class="form-control"  value='<?php echo $row['address']; ?>'> </textarea>
                                                </div>
                                            </div>
                                        </div>
