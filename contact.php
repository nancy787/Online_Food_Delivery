<?php
 ...
 if(isset($_POST["submit"]))
 {
    ...
    $sql="INSERT INTO contact VALUES ('$name','$email','$subject','$message','$solution')";
//   mysqli_query($db,$sql);
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form action="" method="post">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control"  hidden placeholder="Leave a message here" name="solution" style="height: 150px"></textarea>
