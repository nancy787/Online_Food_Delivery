        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Reset your Password</h1>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control w-100 py3" id="name" name="uname" placeholder="Your Name">
                                        <label for="name">User Name</label>
                                    </div>
                                </div>
                                <div class="col-12 ">
                                    <div class="form-floating">
                                        <input type="password" class="form-control w-100"  name="password" placeholder="Change passoword and login again">
                                        <label for="">Change Password</label>
                                    </div>
                                </div>
                                <div class="g-recaptcha" data-sitekey="6LcR4jwfAAAAAN98UigAcheA33af9s2WnMaXG53i">

                                </div>
                                <div class="col-12">
                                    <button class="btn btn-primary w-100 py-3" type="submit" name="submit" >Send Passowrd</button>
                                </div>
